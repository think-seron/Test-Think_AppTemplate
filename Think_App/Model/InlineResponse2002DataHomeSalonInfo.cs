...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class InlineResponse2002DataHomeSalonInfo {
    /// <summary>
    /// サロンID
    /// </summary>
    /// <value>サロンID</value>
    ...
    /// <summary>
    /// bilogが利用可能かどうか0有効,1無効
    /// </summary>
    [DataMember(Name = "bilogAvailable", EmitDefaultValue = false)]
    [JsonProperty(PropertyName = "bilogAvailable")]
    public bool? BilogAvailable { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class InlineResponse2002DataHomeSalonInfo {\n");
